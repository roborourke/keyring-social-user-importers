...
function Keyring_Flickr_User_Importer() {

	class Keyring_Flickr_User_Importer extends Keyring_User_Importer_Base {
		...
		function insert_posts() {
			...
			foreach ( $this->posts as $post ) {
				...
				if (
					...
					$this->sideload_media( $flickr_img, $post_id, $post, apply_filters( 'Keyring_Flickr_User_Importer_image_embed_size', 'large' ) );
...
add_action( 'init', function () {
	Keyring_Flickr_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'flickr',
		'Keyring_Flickr_User_Importer',

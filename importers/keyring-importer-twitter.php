...
function Keyring_Twitter_User_Importer() {

	class Keyring_Twitter_User_Importer extends Keyring_User_Importer_Base {
		...
		function __construct() {
			parent::__construct();
			add_action( 'keyring_user_importer_twitter_custom_options', array( $this, 'custom_options' ) );
		}
...
} // end function Keyring_Twitter_User_Importer


add_action( 'init', function () {
	Keyring_Twitter_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'twitter',
		'Keyring_Twitter_User_Importer',

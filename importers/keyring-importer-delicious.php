...
function Keyring_Delicious_User_Importer() {

	class Keyring_Delicious_User_Importer extends Keyring_User_Importer_Base {
...
add_action( 'init', function () {
	Keyring_Delicious_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'delicious',
		'Keyring_Delicious_User_Importer',

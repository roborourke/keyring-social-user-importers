...
function Keyring_Foursquare_User_Importer() {

	class Keyring_Foursquare_User_Importer extends Keyring_User_Importer_Base {
		...
		function __construct() {
			parent::__construct();
			add_action( 'keyring_user_importer_foursquare_custom_options', array( $this, 'custom_options' ) );
		}
		...
		function extract_posts_from_data( $raw ) {
			...
			foreach ( $importdata->response->checkins->items as $post ) {
				...
				error_log( 'hashtags: ' . var_export( $hashtags, true ) );
				error_log( 'tags: ' . var_export( $tags, true ) );
				error_log( 'opts htags: ' . var_export( $this->get_option( 'hashtags', '' ), true ) );
...
} // end function Keyring_Foursquare_User_Importer


add_action( 'init', function () {
	Keyring_Foursquare_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'foursquare',
		'Keyring_Foursquare_User_Importer',

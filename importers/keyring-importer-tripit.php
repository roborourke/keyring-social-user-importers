...
function Keyring_TripIt_User_Importer() {

class Keyring_TripIt_User_Importer extends Keyring_User_Importer_Base {
...
add_action( 'init', function() {
	Keyring_TripIt_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'tripit',
		'Keyring_TripIt_User_Importer',

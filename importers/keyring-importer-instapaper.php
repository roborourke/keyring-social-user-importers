...
function Keyring_Instapaper_User_Importer() {

class Keyring_Instapaper_User_Importer extends Keyring_User_Importer_Base {
...
add_action( 'init', function() {
	Keyring_Instapaper_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'instapaper',
		'Keyring_Instapaper_User_Importer',

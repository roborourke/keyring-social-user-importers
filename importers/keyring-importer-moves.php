...
function Keyring_Moves_User_Importer() {

class Keyring_Moves_User_Importer extends Keyring_User_Importer_Base {
...
} // end function Keyring_Moves_User_Importer


add_action( 'init', function() {
	Keyring_Moves_User_Importer(); // Load the class code from above
	keyring_register_user_importer(
		'moves',
		'Keyring_Moves_User_Importer',
